...
from telegram.ext.filters import Text  # Ganti Filters menjadi Text untuk filter teks
...
def main():
    ...
    conversation_handler = ConversationHandler(
        ...
        states={
            ID: [MessageHandler(Text & ~Text.command, receive_account_id)],  # Ganti Filters menjadi Text
            SERVER: [MessageHandler(Text & ~Text.command, receive_server)],
            EMAIL: [MessageHandler(Text & ~Text.command, receive_email)],
            PASSWORD: [MessageHandler(Text & ~Text.command, receive_password)],
        },
