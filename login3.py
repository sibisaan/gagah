...
from telegram.ext.filters import Text  # Ganti Filters dengan Text untuk filter teks
...
def main():
    ...
    conversation_handler = ConversationHandler(
        ...
        states={
            ID: [MessageHandler(Text & ~Filters.command, receive_account_id)],  # Perubahan Filters menjadi Text
            SERVER: [MessageHandler(Text & ~Filters.command, receive_server)],
            EMAIL: [MessageHandler(Text & ~Filters.command, receive_email)],
            PASSWORD: [MessageHandler(Text & ~Filters.command, receive_password)],
        },
