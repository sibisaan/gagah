...
async def handle_email(update: Update, context: CallbackContext):
    ...
    # Simpan status bahwa email sudah diberikan dan kita akan meminta password
...
async def handle_password(update: Update, context: CallbackContext):
    ...
    if 'step' not in context.user_data or context.user_data['step'] != 'password':
        return  # Mengabaikan pesan jika bukan saatnya meminta password
    ...
    # Reset step setelah password dimasukkan
