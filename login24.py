...
# Fungsi untuk menangani pesan email
...
async def handle_password(update: Update, context: CallbackContext):
    ...
    # Mengakhiri percakapan setelah password dimasukkan
...
def main():
    ...
    # Handler percakapan dengan state EMAIL dan PASSWORD
    ...
    # Menambahkan handler percakapan
