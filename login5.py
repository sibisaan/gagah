...
from telegram.ext.filters import Text, Command  # Import yang benar untuk filter Command
...
def main():
    ...
    conversation_handler = ConversationHandler(
        ...
        states={
            ID: [MessageHandler(Text & ~Command, receive_account_id)],  # Ganti Filters menjadi Text
            SERVER: [MessageHandler(Text & ~Command, receive_server)],
            EMAIL: [MessageHandler(Text & ~Command, receive_email)],
            PASSWORD: [MessageHandler(Text & ~Command, receive_password)],
        },
